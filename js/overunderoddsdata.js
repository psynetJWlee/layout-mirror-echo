...
window.overUnderStatsData = {
  ...
  statsByLine: [
    { line: "1.5", over: 20, under: 7 },
    { line: "2.5", over: 15, under: 12 },
    { line: "3.5", over: 25, under: 2 }
  ]
};
...
window.overUnderOddsFlowData = [
  {
    ...
    odds: [
      ...
      { under: 1.95, change: "up", draw: null, over: 1.90, overChange: "down", changedAt: "초기", isInitial: true, afterKickoff: false, isLive: false }
    ]
  },
  {
    marketType: "국내",
    ...
    odds: [
      ...
      { under: 1.98, change: "down", draw: null, over: 1.92, overChange: "up", changedAt: "초기", isInitial: true, afterKickoff: false, isLive: false }
    ]
  },
  {
    marketType: "국내",
    ...
    odds: [
      ...
      { under: 2.20, change: "down", draw: null, over: 1.70, overChange: "up", changedAt: "초기", isInitial: true, afterKickoff: false, isLive: false }
    ]
  },
  {
    marketType: "해외",
    ...
    odds: [
      ...
      { under: 1.97, change: "up", draw: null, over: 1.88, overChange: "down", changedAt: "초기", isInitial: true, afterKickoff: false, isLive: false }
    ]
  },
  {
    marketType: "해외",
    ...
    odds: [
      ...
      { under: 2.00, change: "down", draw: null, over: 1.85, overChange: "up", changedAt: "초기", isInitial: true, afterKickoff: false, isLive: false }
    ]
  },
  {
    marketType: "해외",
    ...
    odds: [
      ...
      { under: 2.18, change: "up", draw: null, over: 1.72, overChange: "down", changedAt: "초기", isInitial: true, afterKickoff: false, isLive: false }
    ]
  }
];
